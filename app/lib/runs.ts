...
🟡 low-light: Я-клики 12→7 (в пределах шума окна), Google второй день подряд 0 клк. Якорь «заказать съемку клипа в столица» непрерывно ползёт вниз 5 дней подряд (10.37→11.32) — реальный тренд по Столица. Делать: публикация DTF-статьи — единственный рычаг сдвинуть Столица.
